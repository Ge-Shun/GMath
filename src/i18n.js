...
export const I18N = {
  zh: {
    ...
    aiSave: "保存设置",
    aiRememberKey: "在此设备长期保存 Key",
    aiNote: "默认只在本次任务窗会话保存 Key；识别时图片与 Key 会发送到你填写的接口。",
    insert: "插入到 Word",
    clear: "清空",
    inline: "行内",
    display: "行间",
    ...
    unsupportedFormula: "公式包含暂不支持的结构，已停止写入：",
    unsupportedSelected: "选中的 Word 公式包含暂不支持的结构，已停止自动同步：",
    unsafeSelection: "请只选中一个完整公式；当前选区还包含其它文字或多个公式。",
    selectionChanged: "选区已变化，为避免误替换，已取消同步。请重新点选公式。",
    anchorLost: "公式锚点已被删除，为避免误替换，已断开同步。",
    aiNeedCfg: "请先在「接口设置」里填写 API 地址、Key 和模型。",
    aiBusy: "识别中…（正在调用大模型）",
    aiHttp: "接口返回 ",
    aiNoFormula: "没识别出公式，换一张更清晰、只含公式的图片再试。",
    aiTimeout: "识别请求已超时或被新的识别任务取消。",
    imageTooLarge: "图片过大，请使用不超过 10 MB、2500 万像素的图片。",
  ...
  en: {
    ...
    aiSave: "Save",
    aiRememberKey: "Remember the key on this device",
    aiNote: "By default the key is kept only for this task-pane session; the image and key are sent to the endpoint you set.",
    ...
    unsupportedFormula: "The equation contains an unsupported structure; writing was stopped:",
    unsupportedSelected: "The selected Word equation contains an unsupported structure; auto-sync was stopped:",
    unsafeSelection: "Select exactly one complete equation; the current selection also contains text or multiple equations.",
    selectionChanged: "The selection changed, so sync was cancelled to prevent replacing the wrong content. Select the equation again.",
    anchorLost: "The equation anchor was removed, so sync was disconnected to prevent replacing the wrong content.",
    ...
    aiTimeout: "The recognition request timed out or was cancelled by a newer request.",
    imageTooLarge: "The image is too large; use an image under 10 MB and 25 megapixels.",
