...
const cases = [
  ...
  },
  {
    ...
    mathml: `<math><mfrac><mi>a</mi><mfrac><mi>b</mi><mi>c</mi></mfrac></mfrac></math>`,
  ...
  },
  {
    name: "下标 x_n",
    latex: "x_n",
    mathml: `<math><msub><mi>x</mi><mi>n</mi></msub></math>`,
    expect: ["<m:sSub>", "<m:sub>"],
  },
  {
    name: "上下标 x_n^2",
    latex: "x_n^2",
    mathml: `<math><msubsup><mi>x</mi><mi>n</mi><mn>2</mn></msubsup></math>`,
    expect: ["<m:sSubSup>", "<m:sub>", "<m:sup>"],
  },
  {
    name: "求和（上下限，n-ary）",
    latex: "\\sum_{i=1}^{n} i",
    mathml: `<math><munderover><mo>∑</mo><mrow><mi>i</mi><mo>=</mo><mn>1</mn></mrow><mi>n</mi></munderover><mi>i</mi></math>`,
    expect: ["<m:nary>", `m:chr m:val="∑"`, "<m:sub>", "<m:sup>"],
  },
  {
    name: "积分（上下限，n-ary）",
    latex: "\\int_0^1 x\\,dx",
    mathml: `<math><msubsup><mo>∫</mo><mn>0</mn><mn>1</mn></msubsup><mi>x</mi><mi>d</mi><mi>x</mi></math>`,
    expect: ["<m:nary>", `m:chr m:val="∫"`],
  },
  {
    name: "极限 lim",
    latex: "\\lim_{x\\to 0} f(x)",
    mathml: `<math><munder><mrow><mi>lim</mi></mrow><mrow><mi>x</mi><mo>→</mo><mn>0</mn></mrow></munder><mi>f</mi></math>`,
  ...
  },
  {
    name: "希腊字母 α+β",
    latex: "\\alpha+\\beta",
    mathml: `<math><mi>α</mi><mo>+</mo><mi>β</mi></math>`,
    expect: ["α", "β", "+"],
  },
  {
    name: "质能方程 E=mc^2",
  ...
  },
  {
    ...
    mathml: `<math><mi>x</mi><mo>=</mo><mfrac><mrow><mo>−</mo><mi>b</mi><mo>±</mo><msqrt><mrow><msup><mi>b</mi><mn>2</mn></msup><mo>−</mo><mn>4</mn><mi>a</mi><mo>${IT}</mo><mi>c</mi></mrow></msqrt></mrow><mrow><mn>2</mn><mi>a</mi></mrow></mfrac></math>`,
  ...
  },
  {
    name: "三角函数 sin x",
    latex: "\\sin x",
    mathml: `<math><mi>sin</mi><mo>${IT}</mo><mi>x</mi></math>`,
    expect: ["sin", "x"],
    forbid: [IT],
  },
  {
    ...
    latex: "\\vec{v}",
    mathml: `<math><mover><mi>v</mi><mo stretchy="true">→</mo></mover></math>`,
    expect: ["<m:limUpp>", "v"],
  },
  {
    name: "括号 mfenced",
    latex: "(a+b)",
    mathml: `<math><mfenced open="(" close=")"><mrow><mi>a</mi><mo>+</mo><mi>b</mi></mrow></mfenced></math>`,
    expect: ["<m:d>", `m:begChr m:val="("`, `m:endChr m:val=")"`],
  },
  {
    name: "特殊字符转义 a<b & c",
    latex: "a<b",
    mathml: `<math><mi>a</mi><mo>&lt;</mo><mi>b</mi><mo>&amp;</mo><mi>c</mi></math>`,
    expect: ["&lt;", "&amp;"],
  },
];
